    ...
    <div className={t.container}>
        <div className={t.headerContainer}>
            ...
            <p className={t.subtitle}>
                Real stories from doctors and patients sharing their positive experiences with our health platform.
            </p>
        </div>
        <div className={t.grid} onMouseEnter={()=>setIsPaused(true)} onMouseLeave={()=>setIsPaused(false)}>
