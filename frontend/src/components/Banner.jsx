                ...
                <div className={b.flexContainer}>
                    <div className={b.leftContent}>
                        ...
                        <div className={b.ctaButtonsContainer}>
                                <button onClick={()=>navigate("/doctors")} className={b.bookButton}>
                                ...
                                <button onClick={()=>(window.location.href = "tel:8299431275")} className={b.emergencyButton}>
