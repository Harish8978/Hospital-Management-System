...
export const navbarStyles = {
  ...
  rightContainer: "flex items-center gap-3 ml-3",
  signOutButton: "hidden lg:flex whitespace-nowrap px-4 py-2 cursor-pointer rounded-full bg-amber-500 text-white text-sm items-center gap-2 shadow-sm",
