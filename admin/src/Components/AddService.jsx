...
import { addServiceStyles as a } from '../assets/dummyStyles'
...
//   to fetch services when we are in editing state
 useEffect(() => {
    let mounted = true;
  ...
  return (
    <div className={a.container.main}>
        <div className={a.toast.container}>
            {toast &&(
                <div className={`${a.toast.toastBase} ${toast.type === "error" ? a.toast.toastError : toast.type === 'info'? a.toast.toastInfo : a.toast.toastSuccess } animate-slideIn`}
                >
                    <div className={a.toast.iconContainer(toast.type)}>
                        {toast.type === "error" ? (
                    ...
                    <div className={"flex-1 min-w-0"}>
                        ...
                        <div className={a.toast.message}>{toast.message}</div>
                    </div>
                    <button onClick={()=>setToast(null)} className={a.buttons.toastClose}>
                        <XCircle className={"w-4 h-4 text-gray-400 hover:text-gray-600"}/>
                    </button>
                </div>
            )}
        </div>
        <form onSubmit={handleSubmit} className={a.container.form}>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
                <div>
                    <h1 className={a.header.title}>
                ...
                <div className={a.headerActions}>
                    <button className={a.buttons.reset} type="button" onClick={resetForm}>
                        Reset
                    </button>
                    <button type="submit" disabled={submitting} className={a.buttons.submit}>
                        {submitting ? (
                           <> <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin">Saving..</div></>
                        ):<>
            ...
            {/* left side */}
            <div className={a.grids.main}>
                <div className="lg:col-span-1 md:col-span-1 col-span-1 flex flex-col items-center">
                    <div className={a.imageUpload.container(errors.image)}>
                        <div className={a.imageUpload.preview}>
                            {imagePreview ?(
                                <img src={imagePreview} alt="preview" className="w-full h-full object-cover" />
                            ):(
                                <div className={a.imageUpload.placeholder}>
                        ...
                        <div className={"w-full flex gap-2 items-center"}>
                            ...
                            <button type="button" onClick={()=>fileRef.current?.click()} className={a.buttons.uploadImage}>
                            ...
                            <button
                                ...
                                className={a.buttons.removeImage}
                            >
            ...
            <div className={a.grids.formFields}>
              <div>
                <label className={a.labels.standard}>
                  Service name
                </label>
                <input
                  value={serviceName}
                  ...
                  className={a.formFields.input(errors.serviceName)}
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="₹ 499"
                  className={a.formFields.input(errors.price)}
                  inputMode="numeric"
                />
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className={a.formFields.textarea(errors.about)}
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={a.buttons.addInstruction}
                >
              ...
              <div
                className={a.instructions.container(errors.instructions)}
              >
                {instructions.map((ins, idx) => (
                  <div
                    key={idx}
                    className={a.instructions.item}
                  >
                    <div className={a.icon.number}>
                      {idx + 1}.
                    </div>
                    <input
                      value={ins}
                      ...
                      className={a.instructions.input}
                    />
                    {instructions.length > 1 && (
                      <button
                        type="button"
                        onClick={() => removeInstruction(idx)}
                        className={a.instructions.removeButton}
                      >
                        <Trash2 className={a.icon.removeInstruction} />
                      </button>
                    )}
                  </div>
                ))}
            ...
            {/* slot controls */}
            <div
              className={a.slots.container(errors.slots)}
            >
              ...
              <div className={a.grids.timeGrid}>
                <div className="min-w-0">
                  <label className={a.labels.small}>Day</label>
                  <select
                    value={slotDay}
                    onChange={(e) => setSlotDay(e.target.value)}
                    className={a.formFields.smallSelect}
                  >
                    {days.map((d) => {
                      const dNum = Number(d);
                      const disabled =
                ...
                <div className="min-w-0">
                  <label className={a.labels.small}>Month</label>
                  <select
                    value={slotMonth}
                ...
                <div className="min-w-0">
                  <label className={a.labels.small}>Year</label>
                  <select
                    value={slotYear}
                ...
                <div className={a.grids.timeSubGrid}>
                  <div className="min-w-0">
                    <label className={a.labels.small}>Hour</label>
                    <select
                      value={slotHour}
                      onChange={(e) => setSlotHour(e.target.value)}
                      className={a.formFields.timeSelect}
                    >
                      {hours.map((h) => (
                  ...
                  <div className="min-w-0">
                    <label className={a.labels.small}>Minute</label>
                    <select
                      value={slotMinute}
                  ...
                  <div className="min-w-0">
                    <label className={a.labels.small}>AM/PM</label>
                    <select
                      value={slotAmPm}
                      onChange={(e) => setSlotAmPm(e.target.value)}
                      className={a.formFields.ampmSelect}
                    >
                      {ampm.map((a) => (
              ...
              <div>
                ...
                <div className={a.grids.slotsGrid}>
                  {slots.length === 0 ? (
                    ...
                    slots.map((s, idx) => (
                      <div
                        key={s}
                        className={a.slots.slotItem}
                      >
                        <div className="flex items-center gap-2 min-w-0">
                          <Clock className={a.icon.clock} />
                          <div className={a.slots.slotText}>
                            {s}
                          </div>
                        </div>
                        <button
                          ...
                          className={a.buttons.slotRemove}
                        >
                          <Trash2 className={a.icon.trash} />
                        </button>
                      </div>
                    ))
                  )}
