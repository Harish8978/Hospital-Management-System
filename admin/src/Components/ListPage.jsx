...
const ListPage = () => {
  ...
  // SHOW DOCTORS ACCORDING TO THE FILTERS
  ...
  // SHOW ALL THE DOCTORS ACCORDING TO THE FILTER
            ...
            <div className={s.headerTopSection}>
                ...
                <div className={s.headerSearchContainer}>
                    <div className={s.searchBox}>
                        ...
                        <input value={query} onChange={(e)=>setQuery(e.target.value)} placeholder="Search Doctors either by Name or Specialization!"
                ...
                }
                {
                  !loading && filtered.length === 0 && (
                    <div className={s.noResultsContainer}>
                      No doctors found matching your search or filter criteria.
                    </div>
                  )
                }
                {
                  displayed.map((doc)=>{
                    ...
                    const sorteddDates = getSortedScheduleDates(scheduleMap);

                    return(
                      <article key={id} className={s.article}>
                        <div className={s.articleContent}>
                            <img src={doc.imageUrl || doc.image || ""} alt={doc.name} className={s.doctorImage}/>
                                ...
                                <div className={s.doctorHeader}>
                                    ...
                                    <div className={s.ratingContainer}>
                                        <div className={s.rating}>
                                              <Star size={14}/> {doc.rating || 0}
                                        </div>
                                        <button onClick={()=>toggle(id)} className={s.toggleButton(isOpen)}>
                                              <EyeClosed size={18}/>
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div className={s.aboutSection}>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                          ...
                          {/* expanded details when expand is toggled */}
