    ...
    <div className={s.pageContainer}>
      <div className={s.maxWidthContainer}>
        ...
        <div className={s.statsGrid}>
          <StateCard icon={<Users className='w-6 h-6' />} label="Total Doctors" value={totals.totalDoctors} />
          <StateCard icon={<UserRoundCheck className='w-6 h-6' />} label="Total Registered Users" value={patientCountLoading ? "Loading..." : (patientCount ?? totals.totalLoginPatients)} />
          <StateCard icon={<CalendarRange className='w-6 h-6' />} label="Total Appointments" value={totals.totalAppointments} />
          <StateCard icon={<BadgeIndianRupee className='w-6 h-6' />} label="Total Earnings" value={`Rs ${totals.totalEarnings.toLocaleString()}`} />
          <StateCard icon={<CheckCircle className='w-6 h-6' />} label="Completed" value={totals.completed} />
          <StateCard icon={<XCircle className='w-6 h-6' />} label="Cancelled" value={totals.canceled} />
        </div>
  ...
  return(
    <div className={s.mobileDoctorCard}>
        ...
        <div className={s.mobileStatsGrid}>
            <div className={s.mobileStatLabel}>Appoinments</div>
            ...
            <div className={s.mobileStatValue+" "+s.textRose500}>{d.appointments.cancelled}</div>
        </div>
