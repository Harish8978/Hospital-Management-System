...
import {CheckCircle, Loader, Loader2, Search, XCircle, XIcon} from "lucide-react"
    ...
    <div className={s.container}>
      <header className={s.headerContainer}>
        <div className={s.headerTitleContainer}>
            ...
            <p className={s.headerSubtitle}>Manage Patient Bookings - quick search & status controls</p>
        </div>
            ...
            <div className={s.searchInputWrapper}>
              <label className={s.searchLabel}>
                ...
                <div className={"flex items-center gap-2 relative w-full"}>
                  ...
                  />
                  {search?(
                    <button className={s.clearSearchButton} onClick={()=>setSearch("")}>
